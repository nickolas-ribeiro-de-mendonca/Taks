      ...
      return (
         <View style={styles.container}>
            <AddTask
               ...
               onSave={this.addTask}
            />
            <ImageBackground source={this.getItem()} style={styles.backgound}>
               <View style={styles.iconBar}>
                  ...
                  <TouchableOpacity onPress={this.toggleFielter}>
                     <Icon
            ...
            <View style={styles.taskList}>
               <FlatList
                  data={this.state.visibleTasks.sort((a, b) => a.estimateAt > b.estimateAt)}
